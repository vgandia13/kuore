    ...
    <div className="w-full bg-slate-50 min-h-screen">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-1 cursor-pointer group">
              ...
              <ChevronDown
                size={14}
                className="text-gray-500 mt-1 group-hover:text-black"
              />
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-0.5">
            <Button
              variant="outline"
              size="icon"
              className="h-8 w-8 bg-white border-gray-300 shadow-sm"
            >
            ...
            <Button
              variant="outline"
              size="icon"
              className="h-8 w-8 bg-white border-gray-300 shadow-sm hover:bg-gray-100"
            >
            ...
            <div className="flex items-center border border-gray-300 rounded-md bg-white shadow-sm ml-1 overflow-hidden">
              <Button
                variant="ghost"
                size="icon"
                className="h-8 w-8 rounded-none bg-gray-100 border-r border-gray-300"
              >
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-2 flex items-center justify-between">
        <div className="flex items-center gap-4 text-sm text-gray-600 font-medium">
          <span className="cursor-pointer border-b-2 border-blue-600 text-blue-600 pb-1">
            All Leads
          </span>
          <span className="cursor-pointer hover:text-blue-600 pb-1">
            My Leads
          </span>
        </div>
        <Button
